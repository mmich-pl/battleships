...
func (_m *MockBattleshipClient) FullGameStatus(endpoint string) (*models.FullStatusResponse, error) {
	ret := _m.Called(endpoint)
...
// MockBattleshipClient_FullGameStatus_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FullGameStatus'
type MockBattleshipClient_FullGameStatus_Call struct {
	*mock.Call
}

// FullGameStatus is a helper method to define mock.On call
//   - endpoint string
func (_e *MockBattleshipClient_Expecter) FullGameStatus(endpoint interface{}) *MockBattleshipClient_FullGameStatus_Call {
	return &MockBattleshipClient_FullGameStatus_Call{Call: _e.mock.On("FullGameStatus", endpoint)}
}

func (_c *MockBattleshipClient_FullGameStatus_Call) Run(run func(endpoint string)) *MockBattleshipClient_FullGameStatus_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockBattleshipClient_FullGameStatus_Call) Return(_a0 *models.FullStatusResponse, _a1 error) *MockBattleshipClient_FullGameStatus_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBattleshipClient_FullGameStatus_Call) RunAndReturn(run func(string) (*models.FullStatusResponse, error)) *MockBattleshipClient_FullGameStatus_Call {
	_c.Call.Return(run)
	return _c
}
